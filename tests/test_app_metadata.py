...
class AppMetadataTests(unittest.TestCase):
    def test_public_product_identity_is_meetrec(self):
        ...
        self.assertEqual(app_metadata.APP_VERSION, "1.0.2")
    ...
    def test_packaging_and_release_names_are_meetrec(self):
        ...
        self.assertEqual(app_metadata.WINDOWS_FILE_VERSION, (1, 0, 2, 0))
        self.assertEqual(app_metadata.WINDOWS_PRODUCT_VERSION, (1, 0, 2, 0))
    ...
    def test_windows_version_resource_tracks_app_version(self):
        ...
        self.assertIn("filevers=(1, 0, 2, 0)", version_text)
        self.assertIn("prodvers=(1, 0, 2, 0)", version_text)
        self.assertIn("StringStruct('FileVersion', '1.0.2.0')", version_text)
        self.assertIn("StringStruct('ProductVersion', '1.0.2')", version_text)
